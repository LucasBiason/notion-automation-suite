...
Cria cards principais e subitens com conteúdo detalhado
"""
...
def main():
    ...
    main_card = create_page(ESTUDOS_DB, main_card_properties, icon={"type": "emoji", "emoji": "📊"})
    ...
    formacoes_card = create_page(ESTUDOS_DB, formacoes_properties, main_card_id, icon={"type": "emoji", "emoji": "📚"})
    if formacoes_card:
    ...
    portfolio_card = create_page(ESTUDOS_DB, portfolio_properties, main_card_id, icon={"type": "emoji", "emoji": "💼"})
    if portfolio_card:
    ...
    for formacao in formacoes_list:
        ...
        formacao_card = create_page(ESTUDOS_DB, formacao_properties, icon={"type": "emoji", "emoji": formacao["icon"]})
        if formacao_card:
    ...
    for projeto in projetos_list:
        ...
        projeto_card = create_page(ESTUDOS_DB, projeto_properties, icon={"type": "emoji", "emoji": projeto["icon"]})
        if projeto_card:
