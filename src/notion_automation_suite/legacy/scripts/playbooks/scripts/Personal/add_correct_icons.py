#!/usr/bin/env python3
"""
Script para adicionar os ícones corretos aos cards pessoais criados
"""
...
def main():
    ...
    # Ícones corretos para os cards dos eventos recorrentes
    correct_emojis = ["📝", "💰", "🏥"]
    
    # Adicionar ícones aos 3 cards mais recentes
    for i, card in enumerate(cards[:3]):
        page_id = card["id"]
        emoji = correct_emojis[i] if i < len(correct_emojis) else "📝"
