...
from utils.constants import WORK_CLIENTS, WORK_PROJECTS, Priority, WorkStatus
        ...
        return [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "title": {
                            "type": "string",
                            "description": "Project title (emoji-free).",
                        },
                        "cliente": {
                            "type": "string",
                            "enum": WORK_CLIENTS,
                        ...
                        "periodo": {
                            "type": "object",
                            "description": "Planned period (ISO-8601 GMT-3 start/end).",
                        },
                        "tempo_total": {
                            "type": "string",
                            "description": "Estimated duration (e.g., '08:00:00' for 8h).",
                        },
