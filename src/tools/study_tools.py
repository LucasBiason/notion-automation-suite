...
from utils.constants import StudiesStatus
...
class StudyNotionTools:
    ...
    def _extract_period(payload: Dict[str, Any]) -> Optional[Dict[str, str]]:
        ...
        if not start:
            raise ValueError("Field 'periodo.start' is required whenever 'periodo' is provided.")
        ...
        return [
            {
                ...
                "description": "Create a study course/training (date-only, no time).",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "title": {"type": "string"},
                        ...
                        "tempo_total": {"type": "string", "description": "Total workload (e.g., '40:00:00')."},
            ...
            },
            {
                ...
                "description": "Create a full course with phases, sections, and classes.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "title": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Create a phase of study linked to a course.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
            ...
            },
            {
                ...
                "description": "Create a section linked to a phase or course.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "parent_id": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Create a class respecting the standard schedule (19h-21h, Tuesday 19h30).",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "parent_id": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Reschedule classes for a section (keeps study hour rules).",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "parent_id": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Query classes/sessions within an optional timeframe.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "status": {"type": "string", "enum": STATUS_OPTIONS},
