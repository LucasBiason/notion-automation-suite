...
from notion_mcp.utils.constants import YoutuberStatus
        ...
        return [
            {
                ...
                "description": "Criar série completa com geração automática de episódios.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "title": {"type": "string"},
                        ...
                        "episodes": {
                            "type": "array",
                            "description": "Sobrescreve episódios gerados automaticamente.",
                            "items": {
                                "type": "object",
                                "properties": {
                                    "title": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Criar episódio vinculado a uma série existente.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
            ...
            },
            {
                ...
                "description": "Gerar episódios sequenciais para uma série já existente.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        ...
                        "recording_interval_days": {"type": "integer", "default": 1},
                        "publication_hour": {"type": "integer", "default": 12},
                        "base_title": {"type": "string", "default": "Episódio"},
                    },
            ...
            },
            {
                ...
                "description": "Atualizar status do episódio (Para gravar, Gravado, Publicado).",
                "inputSchema": {
                    "type": "object",
                    "properties": {
            ...
            },
            {
                ...
                "description": "Reagendar gravação e/ou publicação de um episódio.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "episode_id": {"type": "string"},
            ...
            },
            {
                ...
                "description": "Consultar episódios filtrando por status e período de lançamento.",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "status": {"type": "string", "enum": STATUS_OPTIONS},
